...
const Data = (() => {
  ...
  // An item (faction/npc) is locked from players unless admin or explicitly unlocked.
  function isLocked(item) {
    if (mode === 'admin') return false;   // admin always sees everything unlocked
  ...
  return {
    ...
    isFieldVisible, isLocked, canEditCampaign, canEditNotes,
